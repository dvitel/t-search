...
test_0 = Benchmark("test_0", lambda x: x * x * x * x + x * x * x + x * x + x, partial(get_rand_interval_points, transpose=True, pick_rand_grid_points=False), {"num_samples": 5, "ranges": [(-1.0, 1.0)]})
